...
public class MainMenu {
	...
	public static void main(String[] args) {
		...
		System.out.println(Raccolta.storie.get(0).paragrafi.get(3).getId());
		System.out.println(Raccolta.storie.get(0).paragrafi.get(3).getTipo());
		System.out.println(Raccolta.storie.get(0).paragrafi.get(3).getLink());
